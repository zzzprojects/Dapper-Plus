...
namespace Z.Test
{
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		{
			// Title2: IdentitySingle_IdentitySingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("9b736b6b-0264-4f57-a577-cb1c2b3c5cbd").Table("EntitySimple_TriggerOutput").Identity(x => x.Single1).Identity(x => x.Single2);cn.BulkInsert("9b736b6b-0264-4f57-a577-cb1c2b3c5cbd", single);
            }
