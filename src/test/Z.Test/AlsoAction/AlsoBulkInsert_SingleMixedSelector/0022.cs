...
namespace Z.Test
{
    public partial class AlsoAction_AlsoBulkInsert_SingleMixedSelector
    {
		[TestMethod]
		public void Z_Test_0022()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert(single1).AlsoBulkInsert(x => x.Single2, x => x.Many2, x => x.Many3);
            }
