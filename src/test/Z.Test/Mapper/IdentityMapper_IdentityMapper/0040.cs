...
namespace Z.Test
{
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		{
			// Title2: IdentityMany_IdentityMany
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("16701426-10d2-4265-921f-d700eaa196fd").Table("EntitySimple_TriggerOutput").Identity(x => new {x.Many1, x.Many2}).Identity(x => new { x.Many3, x.Many4});cn.BulkInsert("16701426-10d2-4265-921f-d700eaa196fd", single);
            }
