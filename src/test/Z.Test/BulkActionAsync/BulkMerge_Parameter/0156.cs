...
namespace Z.Test
{
    public partial class BulkActionAsync_BulkMerge_Parameter
    {
		[TestMethod]
		public async Task Z_Test_0156()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                await cn.BulkActionAsync(action => action.BulkMerge("key", many1, many2, many3));
            }
