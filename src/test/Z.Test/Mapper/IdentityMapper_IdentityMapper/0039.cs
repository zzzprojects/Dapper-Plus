...
namespace Z.Test
{
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		{
			// Title2: IdentityMany_IdentitySingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("8f841f7c-c555-4553-9cb6-9985db1b3eb0").Table("EntitySimple_TriggerOutput").Identity(x => new {x.Many1, x.Many2}).Identity(x => x.Single2, "Single2_Destination");cn.BulkInsert("8f841f7c-c555-4553-9cb6-9985db1b3eb0", single);
            }
