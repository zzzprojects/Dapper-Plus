    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0011()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("c3d1e63f-965b-4d82-a8fb-71c9f218ce38").Map(x => new {x.Many1, x.Many2});cn.BulkInsert("c3d1e63f-965b-4d82-a8fb-71c9f218ce38", single);
            }
