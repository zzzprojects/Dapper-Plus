...
namespace Z.Test
{
    public partial class Mapper_OutputMapper_OutputMapper
    {
		...
		{
			// Title2: OutputSingle_OutputSingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("9d5af171-8c4f-45d4-bb2d-8c5577e932fc").Table("EntitySimple_TriggerOutput").Output(x => x.Single1).Output(x => x.Single2, "Single2_Destination");cn.BulkInsert("9d5af171-8c4f-45d4-bb2d-8c5577e932fc", single);
            }
