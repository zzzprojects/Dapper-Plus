...
namespace Z.Test
{
    public partial class AlsoAction_AlsoBulkDelete_SingleMixedSelector
    {
		[TestMethod]
		public void Z_Test_0098()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkDelete("key", single1).AlsoBulkDelete("key", x => x.Single2, x => x.Many2, x => x.Many3);
            }
