		...
		public void Z_Test_0069()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					...
					try
					{
					   DapperPlusManager.Entity<EntitySimple_Mapper>("86d24112-abfa-4739-a965-c894207ba83e").Map(x => x.Single1).Map(x => x.Single1, "Single1");cn.BulkInsert("86d24112-abfa-4739-a965-c894207ba83e", single);
					}
