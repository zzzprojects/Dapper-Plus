...
namespace Z.Test
{
    public partial class Mapper_MapMapped_MapMapped
    {
		[TestMethod]
		public void Z_Test_0072()
		{
			// Title2: MapDestination_NotMapped
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("646c6619-3354-414e-b6f1-19114ecc7ed6").Map(x => x.Single1).Map(x => x.Single2, "Single2");cn.BulkInsert("646c6619-3354-414e-b6f1-19114ecc7ed6", single);
            }
