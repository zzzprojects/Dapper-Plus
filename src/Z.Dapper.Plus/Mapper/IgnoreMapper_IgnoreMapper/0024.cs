    ...
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		...
		public void Z_Test_0024()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("db48821e-69e5-4b0b-93f4-2eae5ae285d0").Ignore(x => new {x.Many1, x.Many2});cn.BulkInsert("db48821e-69e5-4b0b-93f4-2eae5ae285d0", single);
            }
