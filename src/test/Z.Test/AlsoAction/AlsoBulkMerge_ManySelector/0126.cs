...
namespace Z.Test
{
    public partial class AlsoAction_AlsoBulkMerge_ManySelector
    {
		[TestMethod]
		public void Z_Test_0126()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkMerge("key", many1).AlsoBulkMerge("key", x => x.Single1, x => x.Single2, x => x.Single3);
            }
