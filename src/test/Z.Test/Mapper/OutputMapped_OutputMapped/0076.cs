...
namespace Z.Test
{
    public partial class Mapper_OutputMapped_OutputMapped
    {
		[TestMethod]
		public void Z_Test_0076()
		{
			// Title2: OutputDestination_MappedDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("67b2f965-837f-4635-9e55-63db9f186a30").Map(x => x.Single1, "Single1").Output(x => x.Single1, "Single1");cn.BulkInsert("67b2f965-837f-4635-9e55-63db9f186a30", single);
            }
