...
namespace Z.Test
{
    public partial class Mapper_OutputMapper_OutputMapper
    {
		...
		{
			// Title2: OutputSingle_OutputMany
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("a2814140-2f0a-4f78-a470-e3429375170b").Table("EntitySimple_TriggerOutput").Output(x => x.Single1).Output(x => new { x.Many3, x.Many4});cn.BulkInsert("a2814140-2f0a-4f78-a470-e3429375170b", single);
            }
