...
namespace Z.Test
{
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		{
			// Title2: MapMany_MapSingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("c9fd2cab-9506-4f0e-b7bf-521fbe8dfae7").Map(x => new {x.Many1, x.Many2}).Map(x => x.Single2, "Single2_Destination");cn.BulkInsert("c9fd2cab-9506-4f0e-b7bf-521fbe8dfae7", single);
            }
