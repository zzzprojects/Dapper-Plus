...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0063()
		{
			// Title2: OutputManyDestination_OutputSingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("6b6f7eb0-8b4b-4de6-9a3c-41069ae4d684").Table("EntitySimple_TriggerOutput").Output(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Output(x => x.Single2);cn.BulkInsert("6b6f7eb0-8b4b-4de6-9a3c-41069ae4d684", single);
            }
