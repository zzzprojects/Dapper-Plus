...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0054()
		{
			// Title2: OutputSingleDestination_OutputSingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("1c0fb99c-c523-4cbb-9cd2-39b503aee8bd").Table("EntitySimple_TriggerOutput").Output(x => x.Single1, "Single1_Destination").Output(x => x.Single2, "Single2_Destination");cn.BulkInsert("1c0fb99c-c523-4cbb-9cd2-39b503aee8bd", single);
            }
