...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0064()
		{
			// Title2: OutputManyDestination_OutputSingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("db9dd12b-2432-4507-9a12-d66081a1db6f").Table("EntitySimple_TriggerOutput").Output(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Output(x => x.Single2, "Single2_Destination");cn.BulkInsert("db9dd12b-2432-4507-9a12-d66081a1db6f", single);
            }
