    ...
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		public void Z_Test_0037()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("f9b0ed54-1be8-444f-95d5-fdb6172dad50").Table("EntitySimple_TriggerOutput").Identity(x => new {x.Many1, x.Many2});cn.BulkInsert("f9b0ed54-1be8-444f-95d5-fdb6172dad50", single);
            }
