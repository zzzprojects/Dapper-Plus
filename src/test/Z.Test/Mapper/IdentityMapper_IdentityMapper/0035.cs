...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0035()
		{
			// Title2: IdentitySingleDestination_IdentityMany
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("dbd0e599-1aa4-40bb-b920-ab9f2709f24b").Table("EntitySimple_TriggerOutput").Identity(x => x.Single1, "Single1_Destination").Identity(x => new { x.Many3, x.Many4});cn.BulkInsert("dbd0e599-1aa4-40bb-b920-ab9f2709f24b", single);
            }
