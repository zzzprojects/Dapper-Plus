    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0007()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("912f6a7a-7430-4ece-8818-a4f15a240f36").Map(x => x.Single1, "Single1_Destination").Map(x => x.Single2);cn.BulkInsert("912f6a7a-7430-4ece-8818-a4f15a240f36", single);
            }
