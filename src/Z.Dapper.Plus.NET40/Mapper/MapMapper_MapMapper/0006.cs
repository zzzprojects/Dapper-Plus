    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0006()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("a1cc60eb-e596-41fa-b3cb-e4153761944b").Map(x => x.Single1, "Single1_Destination");cn.BulkInsert("a1cc60eb-e596-41fa-b3cb-e4153761944b", single);
            }
