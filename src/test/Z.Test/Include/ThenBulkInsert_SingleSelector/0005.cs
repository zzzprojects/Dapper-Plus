...
namespace Z.Test
{
    public partial class Include_ThenBulkInsert_SingleSelector
    {
		[TestMethod]
		public void Z_Test_0005()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert(single1).Include(action => action.ThenBulkInsert(x => x.Many1, x => x.Many2, x => x.Many3));
            }
