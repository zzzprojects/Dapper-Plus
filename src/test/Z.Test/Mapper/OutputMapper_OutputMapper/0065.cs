...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0065()
		{
			// Title2: OutputManyDestination_OutputMany
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("182ccd49-958b-4e23-b937-e5cb1c0cda2e").Table("EntitySimple_TriggerOutput").Output(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Output(x => new { x.Many3, x.Many4});cn.BulkInsert("182ccd49-958b-4e23-b937-e5cb1c0cda2e", single);
            }
