...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0036()
		{
			// Title2: IdentitySingleDestination_IdentityManyDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("f4183c7f-3ee8-4b34-890b-3e26fb938b88").Table("EntitySimple_TriggerOutput").Identity(x => x.Single1, "Single1_Destination").Identity(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("f4183c7f-3ee8-4b34-890b-3e26fb938b88", single);
            }
