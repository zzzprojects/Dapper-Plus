...
namespace Z.Test
{
    public partial class Mapper_OutputMapped_OutputMapped
    {
		...
		{
			// Title2: OutputDestination_NotMapped
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					...
					try
					{
					   DapperPlusManager.Entity<EntitySimple_Mapper>("2d8b65de-c5be-45b6-b863-079fce14c392").Map(x => x.Single1).Output(x => x.Single2, "Single2");cn.BulkInsert("2d8b65de-c5be-45b6-b863-079fce14c392", single);
					}
