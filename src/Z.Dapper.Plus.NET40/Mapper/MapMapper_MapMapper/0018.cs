...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0018()
		{
			// Title2: MapManyDestination_MapSingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("abc3dfdc-9e29-4e4a-b746-38aa175c4b2b").Map(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Map(x => x.Single2, "Single2_Destination");cn.BulkInsert("abc3dfdc-9e29-4e4a-b746-38aa175c4b2b", single);
            }
