...
namespace Z.Test
{
    public partial class Bulk_BulkAction_BulkMerge_SingleSelector
    {
		[TestMethod]
		public void Z_Test_0166()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert((SingleMany)null).BulkMerge("key", single1, x => x.Many1, x => x.Many2, x => x.Many3);
            }
