...
namespace Z.Test
{
    public partial class Bulk_BulkAction_BulkUpdate_ManyMixedSelector
    {
		[TestMethod]
		public void Z_Test_0094()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert((SingleMany)null).BulkUpdate("key", many1, x => x.Single2, x => x.Many2, x=> x.Many3);
            }
