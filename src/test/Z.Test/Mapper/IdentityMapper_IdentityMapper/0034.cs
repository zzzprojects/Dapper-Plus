...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0034()
		{
			// Title2: IdentitySingleDestination_IdentitySingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("02acd990-da3c-4559-a3c9-e33ebb32acd7").Table("EntitySimple_TriggerOutput").Identity(x => x.Single1, "Single1_Destination").Identity(x => x.Single2, "Single2_Destination");cn.BulkInsert("02acd990-da3c-4559-a3c9-e33ebb32acd7", single);
            }
