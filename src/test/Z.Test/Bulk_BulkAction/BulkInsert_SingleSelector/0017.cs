...
namespace Z.Test
{
    public partial class Bulk_BulkAction_BulkInsert_SingleSelector
    {
		[TestMethod]
		public void Z_Test_0017()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert((SingleMany)null).BulkInsert(single1, x => x.Many1, x => x.Many2, x => x.Many3);
            }
