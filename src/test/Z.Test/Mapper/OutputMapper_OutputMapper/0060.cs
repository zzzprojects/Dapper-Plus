    ...
    public partial class Mapper_OutputMapper_OutputMapper
    {
		...
		public void Z_Test_0060()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("8201e060-e0f4-43df-a378-b834d602a88a").Table("EntitySimple_TriggerOutput").Output(x => new {x.Many1, x.Many2}).Output(x => new { x.Many3, x.Many4});cn.BulkInsert("8201e060-e0f4-43df-a378-b834d602a88a", single);
            }
