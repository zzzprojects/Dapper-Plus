    ...
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		...
		public void Z_Test_0024()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("c98e40c9-dfdc-4bf8-a510-8db3f5a1a25a").Ignore(x => new {x.Many1, x.Many2});cn.BulkInsert("c98e40c9-dfdc-4bf8-a510-8db3f5a1a25a", single);
            }
