...
namespace Z.Test
{
    public partial class Include_ThenBulkMerge_SingleSelector
    {
		[TestMethod]
		public void Z_Test_0070()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkMerge("key", single1).Include(action => action.ThenBulkMerge("key", x => x.Many1, x => x.Many2, x => x.Many3));
            }
