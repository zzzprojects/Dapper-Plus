...
<div class="row">
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<p class="lead">Dapper Plus Tutotrial</p>
			<hr class="my-4">
			<p>Start learning about how to use Dapper Plus with our tutorial.</p>
			<p class="lead">
	...
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning the common API of Dapper Plus, and everything around it.</p>
			<p class="lead">
	...
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning Dapper Plus best practices and solution to the common problem you may encounter.</p>
			<p class="lead">
