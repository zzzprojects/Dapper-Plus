    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0006()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("52162105-9d6e-472e-9a24-d29bf0b81648").Map(x => x.Single1, "Single1_Destination");cn.BulkInsert("52162105-9d6e-472e-9a24-d29bf0b81648", single);
            }
