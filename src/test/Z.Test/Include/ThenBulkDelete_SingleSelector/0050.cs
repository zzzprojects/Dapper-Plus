...
namespace Z.Test
{
    public partial class Include_ThenBulkDelete_SingleSelector
    {
		[TestMethod]
		public void Z_Test_0050()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkDelete("key", single1).Include(action => action.ThenBulkDelete("key", x => x.Many1, x => x.Many2, x => x.Many3));
            }
