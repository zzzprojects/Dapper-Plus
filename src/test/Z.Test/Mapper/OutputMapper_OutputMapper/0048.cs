...
namespace Z.Test
{
    public partial class Mapper_OutputMapper_OutputMapper
    {
		...
		{
			// Title2: OutputSingle_OutputSingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("bfd78c04-9c7e-40e7-a940-1cf37a0376ea").Table("EntitySimple_TriggerOutput").Output(x => x.Single1).Output(x => x.Single2);cn.BulkInsert("bfd78c04-9c7e-40e7-a940-1cf37a0376ea", single);
            }
