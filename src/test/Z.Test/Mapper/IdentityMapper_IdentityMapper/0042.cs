...
namespace Z.Test
{
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		{
			// Title2: IdentityManyDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("5672b926-9071-4244-8c77-441e538662cf").Table("EntitySimple_TriggerOutput").Identity(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2});cn.BulkInsert("5672b926-9071-4244-8c77-441e538662cf", single);
            }
