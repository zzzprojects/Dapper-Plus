		...
		public void Z_Test_0067()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					...
					try
					{
					   DapperPlusManager.Entity<EntitySimple_Mapper>("2a33f3fe-8ee0-4aa5-a4b7-bc83ba09d946").Map(x => x.Single1).Map(x => x.Single1);cn.BulkInsert("2a33f3fe-8ee0-4aa5-a4b7-bc83ba09d946", single);
					}
