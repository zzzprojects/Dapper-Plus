...
namespace Z.Test
{
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		{
			// Title2: MapManyDestination_MapSingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("88583f74-ca87-4fdc-860c-054616898d1e").Map(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Map(x => x.Single2);cn.BulkInsert("88583f74-ca87-4fdc-860c-054616898d1e", single);
            }
