    ...
    public partial class Mapper_OutputMapped_OutputMapped
    {
		...
		public void Z_Test_0073()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("45e38c0c-1d24-491f-bcbb-c647312b7b03").Map(x => x.Single1).Output(x => x.Single1);cn.BulkInsert("45e38c0c-1d24-491f-bcbb-c647312b7b03", single);
            }
