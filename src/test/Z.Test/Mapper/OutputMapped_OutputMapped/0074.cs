...
namespace Z.Test
{
    public partial class Mapper_OutputMapped_OutputMapped
    {
		...
		{
			// Title2: Output_MappedDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("e9afc9fc-b5af-47df-bd32-d45647951add").Map(x => x.Single1, "Single1").Output(x => x.Single1);cn.BulkInsert("e9afc9fc-b5af-47df-bd32-d45647951add", single);
            }
