    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0002()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("9f94fbcc-6b94-40b9-9015-b7867b96b963").Map(x => x.Single1).Map(x => x.Single2);cn.BulkInsert("9f94fbcc-6b94-40b9-9015-b7867b96b963", single);
            }
