...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0061()
		{
			// Title2: OutputMany_OutputManyDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("de88c65a-e8c5-4246-bc44-1e45321ca017").Table("EntitySimple_TriggerOutput").Output(x => new {x.Many1, x.Many2}).Output(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("de88c65a-e8c5-4246-bc44-1e45321ca017", single);
            }
