...
namespace Z.Test
{
    public partial class Include_ThenBulkInsert_ManySelector
    {
		[TestMethod]
		public void Z_Test_0013()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert(many1).Include(action => action.ThenBulkInsert(x => x.Single1, x => x.Single2, x => x.Single3));
            }
