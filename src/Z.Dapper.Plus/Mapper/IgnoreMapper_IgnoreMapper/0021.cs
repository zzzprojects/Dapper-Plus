    ...
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		...
		public void Z_Test_0021()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("abd89646-3512-40ee-91c2-771b3c795e4c").Ignore(x => x.Single1);cn.BulkInsert("abd89646-3512-40ee-91c2-771b3c795e4c", single);
            }
