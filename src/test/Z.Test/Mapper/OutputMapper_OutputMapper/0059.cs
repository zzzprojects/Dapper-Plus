...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0059()
		{
			// Title2: OutputMany_OutputSingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("2f4d7cb9-534b-4ece-b497-8e78e6fd616e").Table("EntitySimple_TriggerOutput").Output(x => new {x.Many1, x.Many2}).Output(x => x.Single2, "Single2_Destination");cn.BulkInsert("2f4d7cb9-534b-4ece-b497-8e78e6fd616e", single);
            }
