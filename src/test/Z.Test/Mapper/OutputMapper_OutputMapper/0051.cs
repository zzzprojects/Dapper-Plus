...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0051()
		{
			// Title2: OutputSingle_OutputManyDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("484712f3-3860-44c6-a250-c5f15d5aa696").Table("EntitySimple_TriggerOutput").Output(x => x.Single1).Output(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("484712f3-3860-44c6-a250-c5f15d5aa696", single);
            }
