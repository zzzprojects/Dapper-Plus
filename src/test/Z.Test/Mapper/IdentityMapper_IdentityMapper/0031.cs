...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0031()
		{
			// Title2: IdentitySingle_IdentityManyDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("1f239ef8-eb67-4bee-b72d-5a2d43c275a0").Table("EntitySimple_TriggerOutput").Identity(x => x.Single1).Identity(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("1f239ef8-eb67-4bee-b72d-5a2d43c275a0", single);
            }
