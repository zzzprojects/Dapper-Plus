...
namespace Z.Test
{
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		{
			// Title2: IdentitySingle_IdentityMany
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("16f03bcf-3395-471b-885b-78c7f80b3eca").Table("EntitySimple_TriggerOutput").Identity(x => x.Single1).Identity(x => new { x.Many3, x.Many4});cn.BulkInsert("16f03bcf-3395-471b-885b-78c7f80b3eca", single);
            }
