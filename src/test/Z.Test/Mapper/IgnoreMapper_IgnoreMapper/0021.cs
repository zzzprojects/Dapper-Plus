    ...
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		...
		public void Z_Test_0021()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("ab5efd46-de8e-4c03-8452-dbc34a1a771b").Ignore(x => x.Single1);cn.BulkInsert("ab5efd46-de8e-4c03-8452-dbc34a1a771b", single);
            }
