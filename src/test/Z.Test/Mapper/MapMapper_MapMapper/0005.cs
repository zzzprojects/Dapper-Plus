    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0005()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("90362b01-cbdd-40f2-8bc5-77c398efd60a").Map(x => x.Single1).Map(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("90362b01-cbdd-40f2-8bc5-77c398efd60a", single);
            }
