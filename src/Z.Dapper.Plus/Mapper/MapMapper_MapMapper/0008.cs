    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0008()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("381624bf-ee82-413e-836e-e05d463a7e16").Map(x => x.Single1, "Single1_Destination").Map(x => x.Single2, "Single2_Destination");cn.BulkInsert("381624bf-ee82-413e-836e-e05d463a7e16", single);
            }
