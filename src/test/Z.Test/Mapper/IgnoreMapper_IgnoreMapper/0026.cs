    ...
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		...
		public void Z_Test_0026()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("6c7f0f9c-74a0-4ce7-8c9a-73fd49129c9f").Ignore(x => new {x.Many1, x.Many2}).Ignore(x => new { x.Many3, x.Many4});cn.BulkInsert("6c7f0f9c-74a0-4ce7-8c9a-73fd49129c9f", single);
            }
