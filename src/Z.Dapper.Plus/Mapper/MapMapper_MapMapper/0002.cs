    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0002()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("330eb783-e5a2-49fd-baba-3a56eb914e8c").Map(x => x.Single1).Map(x => x.Single2);cn.BulkInsert("330eb783-e5a2-49fd-baba-3a56eb914e8c", single);
            }
