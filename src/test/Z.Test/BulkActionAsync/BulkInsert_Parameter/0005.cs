    ...
    public partial class BulkActionAsync_BulkInsert_Parameter
    {
		...
		public async Task Z_Test_0005()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                await cn.BulkActionAsync(action => action.BulkInsert(many1, many2));
            }
            ...
            // Test
			Assert.AreEqual(many1.Sum(x => x.ColumnInt) + many2.Sum(x => x.ColumnInt), columnInt);
