...
namespace Z.Test
{
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		...
		{
			// Title2: IgnoreSingle_IgnoreSingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("07c8b441-7637-438b-859d-f7081367fd3a").Ignore(x => x.Single1).Ignore(x => x.Single2);cn.BulkInsert("07c8b441-7637-438b-859d-f7081367fd3a", single);
            }
