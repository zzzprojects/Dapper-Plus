    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0014()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("69c68a50-5ceb-4d3d-abeb-e7865aae531d").Map(x => new {x.Many1, x.Many2}).Map(x => new { x.Many3, x.Many4});cn.BulkInsert("69c68a50-5ceb-4d3d-abeb-e7865aae531d", single);
            }
