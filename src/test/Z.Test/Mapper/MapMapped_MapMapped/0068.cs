		...
		public void Z_Test_0068()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					...
					try
					{
					   DapperPlusManager.Entity<EntitySimple_Mapper>("2ddee3b2-719c-4842-bb9e-6ca7bc55b044").Map(x => x.Single1, "Single1").Map(x => x.Single1);cn.BulkInsert("2ddee3b2-719c-4842-bb9e-6ca7bc55b044", single);
					}
