    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0003()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("79767ace-b530-4509-acf7-0155f6782335").Map(x => x.Single1).Map(x => x.Single2, "Single2_Destination");cn.BulkInsert("79767ace-b530-4509-acf7-0155f6782335", single);
            }
