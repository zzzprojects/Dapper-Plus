...
namespace Z.Test
{
    public partial class Include_ThenBulkUpdate_ManySelector
    {
		[TestMethod]
		public void Z_Test_0038()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkUpdate("key", many1).Include(action => action.ThenBulkUpdate("key", x => x.Single1, x => x.Single2, x => x.Single3));
            }
