...
namespace Z.Test
{
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		{
			// Title2: MapSingleDestination_MapSingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("18b61647-6c97-4693-bad0-0aab886338c3").Map(x => x.Single1, "Single1_Destination").Map(x => x.Single2);cn.BulkInsert("18b61647-6c97-4693-bad0-0aab886338c3", single);
            }
