...
namespace Z.Test
{
    public partial class AlsoAction_AlsoBulkUpdate_ManyMixedSelector
    {
		[TestMethod]
		public void Z_Test_0066()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkUpdate(many1).AlsoBulkUpdate(x => x.Single2, x => x.Many2, x=> x.Many3);
            }
