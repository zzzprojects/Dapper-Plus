...
namespace Z.Test
{
    public partial class Bulk_BulkAction_BulkDelete_ManyMixedSelector
    {
		[TestMethod]
		public void Z_Test_0144()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert((SingleMany)null).BulkDelete("key", many1, x => x.Many2, x => x.Single2, x=> x.Single3);
            }
