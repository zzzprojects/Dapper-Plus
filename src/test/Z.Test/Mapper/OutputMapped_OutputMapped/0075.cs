...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0075()
		{
			// Title2: OutputDestination_Mapped
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("3aa9a0a6-69ef-47fc-9bbf-7379e9e27d2b").Map(x => x.Single1).Output(x => x.Single1, "Single1");cn.BulkInsert("3aa9a0a6-69ef-47fc-9bbf-7379e9e27d2b", single);
            }
