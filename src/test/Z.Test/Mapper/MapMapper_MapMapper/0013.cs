    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0013()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("34454bbf-4288-4d5d-9319-5b7c73e50fee").Map(x => new {x.Many1, x.Many2}).Map(x => x.Single2, "Single2_Destination");cn.BulkInsert("34454bbf-4288-4d5d-9319-5b7c73e50fee", single);
            }
