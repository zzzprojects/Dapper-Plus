...
namespace Z.Test
{
    public partial class Bulk_BulkAction_BulkInsert_ManyMixedSelector
    {
		[TestMethod]
		public void Z_Test_0042()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert((SingleMany)null).BulkInsert(many1, x => x.Single2, x => x.Many2, x=> x.Many3);
            }
