...
namespace Z.Test
{
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		{
			// Title2: IdentityMany_IdentitySingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("0e1790bc-1be8-4046-914f-df50f72f10cb").Table("EntitySimple_TriggerOutput").Identity(x => new {x.Many1, x.Many2}).Identity(x => x.Single2);cn.BulkInsert("0e1790bc-1be8-4046-914f-df50f72f10cb", single);
            }
