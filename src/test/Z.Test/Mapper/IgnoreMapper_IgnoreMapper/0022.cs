    ...
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		...
		public void Z_Test_0022()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("640daf9b-e93f-461e-997c-de748d5b6c76").Ignore(x => x.Single1).Ignore(x => x.Single2);cn.BulkInsert("640daf9b-e93f-461e-997c-de748d5b6c76", single);
            }
