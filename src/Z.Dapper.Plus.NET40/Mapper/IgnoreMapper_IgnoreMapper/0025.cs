...
namespace Z.Test
{
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		...
		{
			// Title2: IgnoreMany_IgnoreSingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("39a6867a-61be-4aa6-b843-13ba580310a7").Ignore(x => new {x.Many1, x.Many2}).Ignore(x => x.Single2);cn.BulkInsert("39a6867a-61be-4aa6-b843-13ba580310a7", single);
            }
