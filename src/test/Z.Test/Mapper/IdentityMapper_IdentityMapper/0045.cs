...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0045()
		{
			// Title2: IdentityManyDestination_IdentityMany
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("6c3d65ce-bcbc-4f75-b542-2a8a9c594eaf").Table("EntitySimple_TriggerOutput").Identity(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Identity(x => new { x.Many3, x.Many4});cn.BulkInsert("6c3d65ce-bcbc-4f75-b542-2a8a9c594eaf", single);
            }
