...
namespace Z.Test
{
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		{
			// Title2: MapSingle_MapSingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("59b50f4c-8d2f-453d-8b0b-e766619793b8").Map(x => x.Single1).Map(x => x.Single2, "Single2_Destination");cn.BulkInsert("59b50f4c-8d2f-453d-8b0b-e766619793b8", single);
            }
