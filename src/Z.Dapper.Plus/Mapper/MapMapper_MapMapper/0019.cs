...
namespace Z.Test
{
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		{
			// Title2: MapManyDestination_MapMany
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("89b0836a-2ce0-431e-bfdf-e90ef01f07e8").Map(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Map(x => new { x.Many3, x.Many4});cn.BulkInsert("89b0836a-2ce0-431e-bfdf-e90ef01f07e8", single);
            }
