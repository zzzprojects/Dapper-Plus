...
namespace Z.Test
{
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		{
			// Title2: MapMany_MapManyDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("286a489b-0177-4a3d-a8e0-fd37c2b9d978").Map(x => new {x.Many1, x.Many2}).Map(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("286a489b-0177-4a3d-a8e0-fd37c2b9d978", single);
            }
