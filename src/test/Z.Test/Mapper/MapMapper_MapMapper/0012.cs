    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0012()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("127bbf3d-fd1e-461a-a463-165ade0a6003").Map(x => new {x.Many1, x.Many2}).Map(x => x.Single2);cn.BulkInsert("127bbf3d-fd1e-461a-a463-165ade0a6003", single);
            }
