    ...
    public partial class Mapper_OutputMapper_OutputMapper
    {
		...
		public void Z_Test_0047()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("b82600c4-1d20-40a7-8cf1-a57ee9d1b56f").Table("EntitySimple_TriggerOutput").Output(x => x.Single1);cn.BulkInsert("b82600c4-1d20-40a7-8cf1-a57ee9d1b56f", single);
            }
