...
namespace Z.Test
{
    public partial class Include_ThenBulkDelete_ManySelector
    {
		[TestMethod]
		public void Z_Test_0053()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkDelete(many1).Include(action => action.ThenBulkDelete(x => x.Single1, x => x.Single2, x => x.Single3));
            }
