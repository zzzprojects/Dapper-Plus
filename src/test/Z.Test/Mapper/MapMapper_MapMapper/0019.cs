    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0019()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("e63c4eea-0cb9-481e-8f66-6816b7fd7840").Map(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Map(x => new { x.Many3, x.Many4});cn.BulkInsert("e63c4eea-0cb9-481e-8f66-6816b7fd7840", single);
            }
