    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0009()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("ca3b543e-f7ab-4852-8bf9-c6f9466e5215").Map(x => x.Single1, "Single1_Destination").Map(x => new { x.Many3, x.Many4});cn.BulkInsert("ca3b543e-f7ab-4852-8bf9-c6f9466e5215", single);
            }
