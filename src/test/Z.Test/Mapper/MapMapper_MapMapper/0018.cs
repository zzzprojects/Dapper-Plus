    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0018()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("fc9030b9-c27a-4b76-b002-d39b7cb6b3fc").Map(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Map(x => x.Single2, "Single2_Destination");cn.BulkInsert("fc9030b9-c27a-4b76-b002-d39b7cb6b3fc", single);
            }
