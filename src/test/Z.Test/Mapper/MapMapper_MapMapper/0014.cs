    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0014()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("43878232-ace2-4ba3-9cc0-3390e488c1ca").Map(x => new {x.Many1, x.Many2}).Map(x => new { x.Many3, x.Many4});cn.BulkInsert("43878232-ace2-4ba3-9cc0-3390e488c1ca", single);
            }
