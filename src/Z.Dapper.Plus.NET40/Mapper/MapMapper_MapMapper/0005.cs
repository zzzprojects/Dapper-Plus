...
namespace Z.Test
{
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		{
			// Title2: MapSingle_MapManyDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("8c182ccd-aa44-47fe-bfbd-2ce74ec1130d").Map(x => x.Single1).Map(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("8c182ccd-aa44-47fe-bfbd-2ce74ec1130d", single);
            }
