    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0015()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("672000d4-1526-4290-9e68-bcc46478bd20").Map(x => new {x.Many1, x.Many2}).Map(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("672000d4-1526-4290-9e68-bcc46478bd20", single);
            }
