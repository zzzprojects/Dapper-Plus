...
namespace Z.Test
{
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		{
			// Title2: IdentitySingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("266b6305-53b1-4205-b7ad-85953e8bf140").Table("EntitySimple_TriggerOutput").Identity(x => x.Single1, "Single1_Destination");cn.BulkInsert("266b6305-53b1-4205-b7ad-85953e8bf140", single);
            }
