    ...
    public partial class BulkActionAsync_BulkInsert_SingleSelector
    {
		...
		public async Task Z_Test_0013()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                await cn.BulkActionAsync(action => action.BulkInsert(single1, x => x.Single2));
            }
            ...
            // Test
			Assert.AreEqual(single1.ColumnInt + single2.ColumnInt, columnInt);
