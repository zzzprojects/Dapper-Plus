...
namespace Z.Test
{
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		{
			// Title2: IdentitySingleDestination_IdentitySingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("b0938b9b-1c64-431d-95cc-dca5de894a51").Table("EntitySimple_TriggerOutput").Identity(x => x.Single1, "Single1_Destination").Identity(x => x.Single2);cn.BulkInsert("b0938b9b-1c64-431d-95cc-dca5de894a51", single);
            }
