    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0004()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("f07f94f0-454c-4332-9056-22c67076bd27").Map(x => x.Single1).Map(x => new { x.Many3, x.Many4});cn.BulkInsert("f07f94f0-454c-4332-9056-22c67076bd27", single);
            }
