    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0004()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("b51d5881-95f4-4479-81d1-0f6f880f41c9").Map(x => x.Single1).Map(x => new { x.Many3, x.Many4});cn.BulkInsert("b51d5881-95f4-4479-81d1-0f6f880f41c9", single);
            }
