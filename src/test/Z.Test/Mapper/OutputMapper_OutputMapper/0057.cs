    ...
    public partial class Mapper_OutputMapper_OutputMapper
    {
		...
		public void Z_Test_0057()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("30d7379e-138c-4cff-a813-d6e37792a050").Table("EntitySimple_TriggerOutput").Output(x => new {x.Many1, x.Many2});cn.BulkInsert("30d7379e-138c-4cff-a813-d6e37792a050", single);
            }
