...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0062()
		{
			// Title2: OutputManyDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("f052f290-9cb8-41c6-ad1d-11939dc40cd1").Table("EntitySimple_TriggerOutput").Output(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2});cn.BulkInsert("f052f290-9cb8-41c6-ad1d-11939dc40cd1", single);
            }
