    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0010()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("43f10224-4a99-494f-bd95-4690f3d654d2").Map(x => x.Single1, "Single1_Destination").Map(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("43f10224-4a99-494f-bd95-4690f3d654d2", single);
            }
