...
namespace Z.Test
{
    public partial class AlsoAction_AlsoBulkDelete_ManySelector
    {
		[TestMethod]
		public void Z_Test_0090()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkDelete("key", many1).AlsoBulkDelete("key", x => x.Single1, x => x.Single2, x => x.Single3);
            }
