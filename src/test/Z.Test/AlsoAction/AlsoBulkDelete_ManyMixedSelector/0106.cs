...
namespace Z.Test
{
    public partial class AlsoAction_AlsoBulkDelete_ManyMixedSelector
    {
		[TestMethod]
		public void Z_Test_0106()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkDelete("key", many1).AlsoBulkDelete("key", x => x.Single2, x => x.Many2, x=> x.Many3);
            }
