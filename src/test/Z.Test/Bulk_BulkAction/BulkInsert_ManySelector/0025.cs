...
namespace Z.Test
{
    public partial class Bulk_BulkAction_BulkInsert_ManySelector
    {
		[TestMethod]
		public void Z_Test_0025()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert((SingleMany)null).BulkInsert(many1, x => x.Single1, x => x.Single2, x => x.Single3);
            }
