    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0016()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("a50df770-0a7c-43bf-b7fc-c58a0e5f7fdb").Map(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2});cn.BulkInsert("a50df770-0a7c-43bf-b7fc-c58a0e5f7fdb", single);
            }
