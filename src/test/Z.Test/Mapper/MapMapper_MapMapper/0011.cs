    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0011()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("8e20d5d1-3964-4d8c-9a52-4fba43227313").Map(x => new {x.Many1, x.Many2});cn.BulkInsert("8e20d5d1-3964-4d8c-9a52-4fba43227313", single);
            }
