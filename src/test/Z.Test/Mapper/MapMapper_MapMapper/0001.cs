    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0001()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("47759b26-fbb7-42f3-94af-95166e61a431").Map(x => x.Single1);cn.BulkInsert("47759b26-fbb7-42f3-94af-95166e61a431", single);
            }
