...
namespace Z.Test
{
    public partial class Include_ThenBulkMerge_ManySelector
    {
		[TestMethod]
		public void Z_Test_0078()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkMerge("key", many1).Include(action => action.ThenBulkMerge("key", x => x.Single1, x => x.Single2, x => x.Single3));
            }
