    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0012()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("098bab70-28ef-4219-b78f-b9c3f4e59b68").Map(x => new {x.Many1, x.Many2}).Map(x => x.Single2);cn.BulkInsert("098bab70-28ef-4219-b78f-b9c3f4e59b68", single);
            }
