...
namespace Z.Test
{
    public partial class AlsoAction_AlsoBulkInsert_ManyMixedSelector
    {
		[TestMethod]
		public void Z_Test_0032()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert(many1).AlsoBulkInsert(x => x.Many2, x => x.Single2, x=> x.Single3);
            }
