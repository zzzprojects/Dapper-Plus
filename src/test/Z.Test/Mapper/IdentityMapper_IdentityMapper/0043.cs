...
namespace Z.Test
{
    ...
    {
		[TestMethod]
		public void Z_Test_0043()
		{
			// Title2: IdentityManyDestination_IdentitySingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("53b88403-f827-4d50-abb9-fd16534be0d5").Table("EntitySimple_TriggerOutput").Identity(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Identity(x => x.Single2);cn.BulkInsert("53b88403-f827-4d50-abb9-fd16534be0d5", single);
            }
