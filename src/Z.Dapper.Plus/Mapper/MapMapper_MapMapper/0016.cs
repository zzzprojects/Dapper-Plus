    ...
    public partial class Mapper_MapMapper_MapMapper
    {
		...
		public void Z_Test_0016()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("a8108f64-31cb-41d8-9651-cfc56f4d7f94").Map(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2});cn.BulkInsert("a8108f64-31cb-41d8-9651-cfc56f4d7f94", single);
            }
