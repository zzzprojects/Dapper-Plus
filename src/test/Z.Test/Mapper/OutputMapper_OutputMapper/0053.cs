...
namespace Z.Test
{
    public partial class Mapper_OutputMapper_OutputMapper
    {
		...
		{
			// Title2: OutputSingleDestination_OutputSingle
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("256e4bc4-b57e-4c87-8573-a6b10768d906").Table("EntitySimple_TriggerOutput").Output(x => x.Single1, "Single1_Destination").Output(x => x.Single2);cn.BulkInsert("256e4bc4-b57e-4c87-8573-a6b10768d906", single);
            }
