...
namespace Z.Test
{
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		[TestMethod]
		public void Z_Test_0026()
		{
			// Title2: IgnoreMany_IgnoreMany
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                DapperPlusManager.Entity<EntitySimple_Mapper>("ccb8b798-bab8-4e49-8e85-878010783468").Ignore(x => new {x.Many1, x.Many2}).Ignore(x => new { x.Many3, x.Many4});cn.BulkInsert("ccb8b798-bab8-4e49-8e85-878010783468", single);
            }
