...
namespace Z.Test
{
    public partial class AlsoAction_AlsoBulkDelete_SingleSelector
    {
		[TestMethod]
		public void Z_Test_0082()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkDelete("key", single1).AlsoBulkDelete("key", x => x.Many1, x => x.Many2, x => x.Many3);
            }
