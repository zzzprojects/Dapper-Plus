    ...
    public partial class Bulk_BulkAction_BulkInsert_SingleMixedSelector
    {
		...
		public void Z_Test_0033()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
                cn.BulkInsert((SingleMany)null).BulkInsert(single1, x => x.Single2, x => x.Many2);
            }
            ...
            // Test
			Assert.AreEqual(single1.ColumnInt + single2.ColumnInt + many2.Sum(x => x.ColumnInt), columnInt);
