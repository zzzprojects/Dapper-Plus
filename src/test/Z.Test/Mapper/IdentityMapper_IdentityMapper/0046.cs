...
namespace Z.Test
{
    public partial class Mapper_IdentityMapper_IdentityMapper
    {
		...
		{
			// Title2: IdentityManyDestination_IdentityManyDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("f03e5501-0345-429f-839a-52554f9463ad").Table("EntitySimple_TriggerOutput").Identity(x => new {Many1_Destination = x.Many1, Many2_Destination = x.Many2}).Identity(x => new { Many3_Destination = x.Many3, Many4_Destination = x.Many4});cn.BulkInsert("f03e5501-0345-429f-839a-52554f9463ad", single);
            }
