...
namespace Z.Test
{
    public partial class Mapper_OutputMapper_OutputMapper
    {
		...
		{
			// Title2: OutputSingleDestination
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("a1ac476a-acaf-46ed-92f2-cc11cc0ae944").Table("EntitySimple_TriggerOutput").Output(x => x.Single1, "Single1_Destination");cn.BulkInsert("a1ac476a-acaf-46ed-92f2-cc11cc0ae944", single);
            }
