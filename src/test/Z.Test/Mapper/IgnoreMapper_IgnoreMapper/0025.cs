    ...
    public partial class Mapper_IgnoreMapper_IgnoreMapper
    {
		...
		public void Z_Test_0025()
		{
            ...
            using (var cn = Helper.GetConnection())
            {
                ...
                // Action
					DapperPlusManager.Entity<EntitySimple_Mapper>("d8e51f2f-9f98-4daa-9c1a-760ae129f947").Ignore(x => new {x.Many1, x.Many2}).Ignore(x => x.Single2);cn.BulkInsert("d8e51f2f-9f98-4daa-9c1a-760ae129f947", single);
            }
